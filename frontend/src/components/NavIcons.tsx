...
export function IconOverview({ className = "h-4 w-4" }: IconProps) {
  return (
...
export function IconWorkflow({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75">
      <circle cx="6" cy="6" r="2" />
      <circle cx="18" cy="6" r="2" />
      <circle cx="12" cy="18" r="2" />
      <path d="M8 6h8M7 7.5 11 16M17 7.5 13 16" />
    </svg>
  );
}
